...
#[derive(Debug, Clone)]
pub struct SearchContext<T: Float + Debug + Send + Sync + 'static> {
    /// Current generation
...
#[derive(Debug, Clone)]
pub struct ControllerStatistics<T: Float + Debug + Send + Sync + 'static> {
...
/// RNN layer
#[derive(Debug, Clone)]
pub struct RNNLayer<T: Float + Debug + Send + Sync + 'static> {
    /// Layer type
    layer_type: RNNType,
...
/// Output projection layer
#[derive(Debug, Clone)]
pub struct OutputLayer<T: Float + Debug + Send + Sync + 'static> {
    /// Weight matrix
    weight: Array2<T>,
...
#[derive(Debug, Clone)]
pub struct TrainingBatch<T: Float + Debug + Send + Sync + 'static> {
    /// Input sequences
...
pub struct TransformerController<T: Float + Debug + Send + Sync + 'static> {
    /// Model configuration
...
/// Feed-forward network
#[derive(Debug, Clone)]
pub struct FeedForward<T: Float + Debug + Send + Sync + 'static> {
    /// First linear layer
...
/// Positional encoding
#[derive(Debug, Clone)]
pub struct PositionalEncoding<T: Float + Debug + Send + Sync + 'static> {
    /// Encoding matrix
    encoding: Array2<T>,
...
pub struct RandomController<T: Float + Debug + Send + Sync + 'static> {
    /// Available component types
    component_types: Vec<ComponentType>,
...
pub struct EvolutionaryController<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct ControllerGenome<T: Float + Debug + Send + Sync + 'static> {
    /// Genome encoding
    encoding: Vec<T>,
...
impl<T: Float + Debug + Default + Clone + Send + Sync + std::iter::Sum> ArchitectureController<T>
...
impl<T: Float + Debug + Default + Clone + Send + Sync + std::iter::Sum> RandomController<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> EmbeddingLayer<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> TransformerLayer<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> MultiHeadAttention<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> FeedForward<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> LinearLayer<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> LayerNorm<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> PositionalEncoding<T> {
...
impl<T: Float + Debug + Default + Send + Sync> Default for ControllerStatistics<T> {
    fn default() -> Self {
        Self {
            total_generated: 0,
            success_rate: 0.0,
