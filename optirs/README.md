...
```toml
[dependencies]
optirs = { version = "0.2.0", features = ["core"] }  # Always included
```

### Hardware Acceleration
```toml
[dependencies]
optirs = { version = "0.2.0", features = ["gpu"] }  # GPU acceleration
```

```toml
[dependencies]
optirs = { version = "0.2.0", features = ["tpu"] }  # TPU coordination
```

### Advanced Optimization
```toml
[dependencies]
optirs = { version = "0.2.0", features = ["learned"] }  # Learned optimizers
```

```toml
[dependencies]
optirs = { version = "0.2.0", features = ["nas"] }  # Neural Architecture Search
```

### Development and Analysis
```toml
[dependencies]
optirs = { version = "0.2.0", features = ["bench"] }  # Benchmarking tools
```

### Full Feature Set
```toml
[dependencies]
optirs = { version = "0.2.0", features = ["full"] }  # All features
```
