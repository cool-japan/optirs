...
```toml
[dependencies]
optirs = { version = "0.3.2", features = ["core"] }  # Always included
```

### Hardware Acceleration
```toml
[dependencies]
optirs = { version = "0.3.2", features = ["gpu"] }  # GPU acceleration
```

```toml
[dependencies]
optirs = { version = "0.3.2", features = ["tpu"] }  # TPU coordination
```

### Advanced Optimization
```toml
[dependencies]
optirs = { version = "0.3.2", features = ["learned"] }  # Learned optimizers
```

```toml
[dependencies]
optirs = { version = "0.3.2", features = ["nas"] }  # Neural Architecture Search
```

### Development and Analysis
```toml
[dependencies]
optirs = { version = "0.3.2", features = ["bench"] }  # Benchmarking tools
```

### Full Feature Set
```toml
[dependencies]
optirs = { version = "0.3.2", features = ["full"] }  # All features
```
