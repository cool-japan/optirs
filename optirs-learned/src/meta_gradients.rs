...
#[derive(Debug, Clone)]
pub struct MetaGradientResult<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct MetaCheckpoint<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct TaskState<T: Float + Debug + Send + Sync + 'static> {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> CheckpointManager<T> {
