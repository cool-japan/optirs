...
pub trait AdvancedOptimizer<T: Float + Debug + Send + Sync + 'static>: Send + Sync + std::fmt::Debug {
...
pub struct AdvancedCoordinator<T: Float + Debug + Send + Sync + std::fmt::Debug> {
