...
impl<T: Float + Debug + Send + Sync + 'static> Default for AdvancedConfig<T> {
    fn default() -> Self {
...
#[derive(Debug, Clone)]
pub struct OptimizationContext<T: Float + Debug + Send + Sync + 'static> {
...
impl<T: Float + Debug + Send + Sync + 'static> AdvancedConfig<T> {
