...
pub trait ExternalConnector<T: Float + Debug + Send + Sync + 'static>: Send + Sync + Debug {
...
pub trait ConflictResolver<T: Float + Debug + Send + Sync + 'static>: Send + Sync + Debug {
    /// Resolve conflict
...
pub trait MessageProducer<T: Float + Debug + Send + Sync + 'static>: Send + Sync + Debug {
    /// Send message
...
pub trait MessageConsumer<T: Float + Debug + Send + Sync + 'static>: Send + Sync + Debug {
    /// Receive message
