...
#[derive(Debug)]
pub struct AdaptationController<T: Float + Debug + Send + Sync + Debug> {
...
pub trait AdaptationTrigger<T: Float + Debug + Send + Sync + 'static>: Send + Sync + Debug {
...
pub trait AdaptationStrategy<T: Float + Debug + Send + Sync + 'static>: Send + Sync + Debug {
...
#[derive(Debug, Clone)]
pub struct SelectionCriteria<T: Float + Debug + Send + Sync + 'static> {
    /// Performance weight
...
impl<T: Float + Debug + Send + Sync + Debug + 'static> AdaptationController<T> {
...
impl<T: Float + Debug + Send + Sync + 'static> AdaptationState<T> {
...
impl<T: Float + Debug + Send + Sync + 'static> Default for AdaptationConfig<T> {
    fn default() -> Self {
        Self {
...
impl<T: Float + Debug + Send + Sync + 'static> PerformanceDegradationTrigger<T> {
...
impl<T: Float + Debug + Send + Sync + 'static> AdaptationTrigger<T> for PerformanceDegradationTrigger<T> {
    fn is_triggered(&self, context: &OptimizationContext<T>) -> bool {
...
impl<T: Float + Debug + Send + Sync + 'static> ResourceConstraintTrigger<T> {
...
impl<T: Float + Debug + Send + Sync + 'static> AdaptationTrigger<T> for ResourceConstraintTrigger<T> {
    fn is_triggered(&self, context: &OptimizationContext<T>) -> bool {
...
impl<T: Float + Debug + Send + Sync + 'static> ConvergenceStagnationTrigger<T> {
...
impl<T: Float + Debug + Send + Sync + 'static> AdaptationTrigger<T> for ConvergenceStagnationTrigger<T> {
    fn is_triggered(&self, context: &OptimizationContext<T>) -> bool {
...
impl<T: Float + Debug + Send + Sync + 'static> LearningRateAdaptationStrategy<T> {
...
impl<T: Float + Debug + Send + Sync + 'static> AdaptationStrategy<T> for LearningRateAdaptationStrategy<T> {
    fn execute_adaptation(
        &mut self,
        context: &OptimizationContext<T>,
...
impl<T: Float + Debug + Send + Sync + 'static> OptimizerSelectionStrategy<T> {
...
impl<T: Float + Debug + Send + Sync + 'static> AdaptationStrategy<T> for OptimizerSelectionStrategy<T> {
    fn execute_adaptation(
        &mut self,
