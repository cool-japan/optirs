...
#[derive(Debug)]
pub struct RLSearchState<T: Float + Debug + Send + Sync + 'static> {
    /// Controller network
...
/// Policy parameters
#[derive(Debug)]
pub struct PolicyParameters<T: Float + Debug + Send + Sync + 'static> {
    /// Policy type
...
impl<T: Float + Debug + Default + std::fmt::Debug + Send + Sync> RLSearchState<T> {
...
impl<T: Float + Debug + Default + Send + Sync> ControllerNetwork<T> {
...
impl<T: Float + Debug + Default + Send + Sync> StateRepresentation<T> {
...
impl<T: Float + Debug + Default + Send + Sync> PolicyParameters<T> {
...
impl<T: Float + Debug + Default + Send + Sync> ExplorationParameters<T> {
...
impl<T: Float + Debug + Default + Send + Sync> ExperienceReplayBuffer<T> {
