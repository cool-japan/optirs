...
#[derive(Debug)]
pub struct BayesianOptimizationState<T: Float + Debug + Send + Sync + 'static> {
...
impl<T: Float + Debug + Default + std::fmt::Debug + From<f64 + Send + Sync> + Into<f64>> BayesianOptimizationState<T> {
...
impl<T: Float + Debug + Default + std::fmt::Debug + Send + Sync> SurrogateModel<T> {
...
pub struct MultiObjectiveBayesianState<T: Float + Debug + Send + Sync + 'static> {
...
impl<T: Float + Debug + Default + std::fmt::Debug + Send + Sync> MultiObjectiveBayesianState<T> {
