...
pub trait EncodingStrategy<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct ArchitectureDefinition<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct EncodedArchitecture<T: Float + Debug + Send + Sync + 'static> {
    /// Encoding type used
...
#[derive(Debug, Clone)]
pub struct EncodingMetadata<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct EncodingQualityMetrics<T: Float + Debug + Send + Sync + 'static> {
...
/// Normalization statistics
#[derive(Debug, Clone)]
pub struct NormalizationStats<T: Float + Debug + Send + Sync + 'static> {
    /// Mean values
    pub mean: Array1<T>,
...
#[derive(Debug)]
pub struct SequentialEncoder<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug)]
pub struct GraphEncoder<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug)]
pub struct TreeEncoder<T: Float + Debug + Send + Sync + 'static> {
    /// Maximum tree depth
    max_depth: usize,
...
#[derive(Debug)]
pub struct PathEncoder<T: Float + Debug + Send + Sync + 'static> {
    /// Maximum path length
...
#[derive(Debug)]
pub struct ContinuousEncoder<T: Float + Debug + Send + Sync + 'static> {
    /// Vector dimension
    vector_dim: usize,
...
/// Variational encoding parameters
#[derive(Debug, Clone)]
pub struct VariationalParams<T: Float + Debug + Send + Sync + 'static> {
    /// Latent dimension
    latent_dim: usize,
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> ArchitectureEncoder<T> {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> SequentialEncoder<T> {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> EncodingStrategy<T> for SequentialEncoder<T> {
    fn encode(&self, architecture: &ArchitectureDefinition<T>) -> Result<EncodedArchitecture<T>> {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> GraphEncoder<T> {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> EncodingStrategy<T> for GraphEncoder<T> {
    fn encode(&self, architecture: &ArchitectureDefinition<T>) -> Result<EncodedArchitecture<T>> {
