...
#[derive(Debug, Clone)]
pub struct GradientBasedNASConfig<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug)]
pub struct DARTSSearcher<T: Float + Debug + Send + Sync + 'static> {
    /// Configuration
...
#[derive(Debug, Clone)]
pub struct CandidateOperation<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct ComputationalCost<T: Float + Debug + Send + Sync + 'static> {
    /// Parameter count
...
/// Operation implementation
#[derive(Debug, Clone)]
pub struct OperationImpl<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug)]
pub struct MixedOperation<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct ArchitectureCandidate<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct ArchitectureComplexity<T: Float + Debug + Send + Sync + 'static> {
    /// Total parameters
...
#[derive(Debug, Clone)]
pub struct DARTSTrainingStats<T: Float + Debug + Send + Sync + 'static> {
...
/// Progressive pruning tracker
#[derive(Debug)]
pub struct PruningTracker<T: Float + Debug + Send + Sync + 'static> {
...
/// Search space constraints
#[derive(Debug, Clone)]
pub struct SearchSpaceConstraints<T: Float + Debug + Send + Sync + 'static> {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> DARTSSearcher<T> {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> DARTSTrainingStats<T> {
    fn new() -> Self {
        Self {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> PruningTracker<T> {
    fn new() -> Self {
        Self {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> Default for PerformanceMetrics<T> {
    fn default() -> Self {
        Self {
