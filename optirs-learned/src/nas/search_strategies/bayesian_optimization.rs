...
#[derive(Debug, Clone)]
pub struct BayesianOptConfig<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug)]
pub struct BayesianArchitectureOptimizer<T: Float + Debug + Send + Sync + 'static> {
    /// Configuration
...
#[derive(Debug)]
pub enum Kernel<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct ArchitectureRepresentation<T: Float + Debug + Send + Sync + 'static> {
...
/// Acquisition function optimizer
#[derive(Debug)]
pub struct AcquisitionOptimizer<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug)]
pub struct SearchHistory<T: Float + Debug + Send + Sync + 'static> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> BayesianArchitectureOptimizer<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> GaussianProcess<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> AcquisitionOptimizer<T> {
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> SearchHistory<T> {
    fn new() -> Self {
        Self {
            evaluations: Vec::new(),
...
impl<T: Float + Debug + Send + Sync + 'static + Default + Clone> Default for BayesianOptConfig<T> {
    fn default() -> Self {
