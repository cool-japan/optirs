...
#[derive(Debug, Clone)]
pub struct Objective<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub enum ScalarizationMethod<T: Float + Debug + Send + Sync + 'static> {
    /// Weighted sum
    WeightedSum,
    /// Weighted product
    WeightedProduct,
...
#[derive(Debug, Clone)]
pub enum ConstraintHandling<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug)]
pub struct MultiObjectiveEvaluator<T: Float + Debug + Send + Sync + 'static> {
    /// Configuration
...
#[derive(Debug, Clone)]
pub struct MultiObjectiveSolution<T: Float + Debug + Send + Sync + 'static> {
    /// Solution identifier
    pub id: String,
...
/// Archive of non-dominated solutions
#[derive(Debug)]
pub struct Archive<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct ObjectiveStats<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct MultiObjectiveEvaluation<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct DominanceInfo<T: Float + Debug + Send + Sync + 'static> {
...
#[derive(Debug, Clone)]
pub struct ScalarizationFunction<T: Float + Debug + Send + Sync + 'static> {
    /// Function identifier
    pub id: String,
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> MultiObjectiveEvaluator<T> {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> ParetoFront<T> {
    fn new() -> Self {
        Self {
            solutions: Vec::new(),
            hypervolume: T::zero(),
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> Archive<T> {
...
impl<T: Float + Debug + Default + Clone + Send + Sync + 'static> Default for MultiObjectiveConfig<T> {
    fn default() -> Self {
        Self {
            objectives: vec![
                Objective {
